...
class ProjectAnalyzer:
    ...
    def __init__(self, project_path: str):
        ...
        # 初始化第三方库检测器
        self.third_party_detector = ThirdPartyDetector(str(self.project_path))
    ...
    def _is_third_party_file(self, file_path: Path) -> bool:
        ...
        Returns:
            bool: 是否为第三方库文件
        """
        return self.third_party_detector.is_third_party_file(file_path)
